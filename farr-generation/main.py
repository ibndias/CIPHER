...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Pentesting Flow Generator and Parser",
        epilog="""
        Examples:
    ...
    generate_parser.add_argument("--api_key", type=str, default=os.getenv("OPENAI_API_KEY"), help="API key for OpenAI. By default, uses the OPENAI_API_KEY environment variable")
    generate_parser.add_argument("--api_base", type=str, default="https://api.openai.com/v1", help="API base URL for OpenAI. By default, uses the OpenAI API base URL")
    generate_parser.add_argument("--model_chosen", type=str, default="gpt-4o-mini", help="Model to use for OpenAI API")
    generate_parser.add_argument("--chunk_size", type=int, default=8000, help="Chunk size for text splitting")
    generate_parser.add_argument("--chunk_overlap", type=int, default=1000, help="Chunk overlap for text splitting")
    ...
    mark_parser.add_argument("--api_key", type=str, default=os.getenv("OPENAI_API_KEY"), help="API key for OpenAI. By default, uses the OPENAI_API_KEY environment variable")
    mark_parser.add_argument("--api_base", type=str, default="https://api.openai.com/v1", help="API base URL for OpenAI. By default, uses the OpenAI API base URL")
    mark_parser.add_argument("--model_chosen", type=str, default="gpt-4", help="Model to use for OpenAI API")
